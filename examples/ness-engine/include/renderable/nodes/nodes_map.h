...
namespace Ness
{
	...
	*/
	...
	public:
		...
		NESSENGINE_API inline NodeAPIPtr& get_node(const Pointi& index) {return m_nodes[index.x][index.y];}
		...
		NESSENGINE_API virtual NodeAPIPtr& get_node_by_position(const Point& position);
