...
namespace Ness
{
	...
	Sprite::Sprite(Renderer* renderer, RenderableParent* parent) : RenderableEntity(renderer, parent)
	{
		set_defaults();
	}

	Sprite::Sprite(Renderer* renderer, RenderableParent* parent, ManagedResources::ManagedTexturePtr texture) : RenderableEntity(renderer, parent)
	{
		set_defaults();
		init_from_texture(texture);
	}

	Sprite::Sprite(Renderer* renderer, RenderableParent* parent, const std::string& TextureFile) : RenderableEntity(renderer, parent)
	{
		set_defaults();
